...
import java.util.*;
//import org.commons.configuration.ConfigurationException;

import pt.isel.adeetc.si1.app.console.presentationlayer.Menu.MenuItem;
...
public class Console {
    ...
    public Console() throws NoSuchMethodException, InvalidPropertiesFormatException, IOException {
        menu = new Menu();
        actions = new Actions();
        running = true;
    }
    ...
    private void ShowMenu() {
        ...
        for (int option = 0; option < numberOfOptions; ++option) {
            MenuItem item = menu.menuItems.get(option);
